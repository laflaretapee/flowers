...
# In containerized deployments collectstatic may fail on chmod() race conditions
# for hashed static files. Leaving permissions to OS defaults avoids startup crashes.
